    ...
    packageSet = with lib;
      ...
      # in the list that is the last argument to the `foldl` above.
      {
        ...
        juno = import ../packages/juno.nix {
          ...
          inherit (self'.packages) libwasmvm_1_5_5;
          inherit cosmosLib;
        };
        ...
        osmosis = import ../packages/osmosis.nix {
          ...
          inherit (self'.packages) libwasmvm_3_0_4;
          inherit cosmosLib;
          inherit (pkgs) libiconv;
        };
      ...
      ([
          ...
          (import ../packages/gaia.nix {
            ...
            inherit (cosmosLib) mkCosmosGoApp;
            inherit (self'.packages) libwasmvm_1_5_0 libwasmvm_2_0_0 libwasmvm_2_1_2 libwasmvm_2_2_3;
          })
          # IBC Go
